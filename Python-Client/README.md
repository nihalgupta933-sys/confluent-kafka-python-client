...
* **[Screenshot 1](./ss/Screenshot%202026-08-07%20203036.png) - Initial Smoke Test**
  Shows a manually published dummy test message inside the Confluent UI dashboard. This verified that partition configurations, keys, and values (`0`) were routing accurately through the cloud cluster.
...
* **[Screenshot 2](./ss/Screenshot%202026-08-08%20133719.png) - Stream Lineage Overview**
...
* **[Screenshot 3](./ss/Screenshot%202026-08-08%20133800.png) - Live Cloud Message Inspection**
...
* **[Screenshot 4](./ss/Screenshot%202026-08-08%20143445.png) - High-Volume Traffic Monitoring**
...
* **[Screenshot 5](./ss/Screenshot%202026-08-08%20194624.png) - Consumer Lineage Visualizer**
...
* **[Screenshot 6](./ss/Screenshot%202026-08-08%20194704.png) - Total Message Auditing**
...
* **[Screenshot 7](./ss/Screenshot%202026-08-08%20200734.png) - Local Console Output Capture**
...
* **[Screenshot 8](./ss/Screenshot%202026-08-09%20142400.png) - End-to-End Value Synchronization**
